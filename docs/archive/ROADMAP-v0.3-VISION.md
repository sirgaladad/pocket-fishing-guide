> **Archived 2026-03-15** — This is the original Phase 1–5 vision document,
> superseded by the current [ROADMAP.md](../../ROADMAP.md). Preserved here for
...
- Contrast with big-box (Walmart, Bass Pro) for local value
